...
const ProtectedRoute = () => {
  return (
    <div className='flex '>
      {/* Fixed Sidebar */}
      <aside className='fixed top-0 left-0 h-full w-[250px] bg-white shadow-sm z-10'>
      ...
      <section className='ml-[250px] flex-1'>
        {/* Fixed Header */}
        <div className='fixed top-0 left-[250px] w-[calc(100%-250px)] bg-white h-[50px] z-20'></div>
