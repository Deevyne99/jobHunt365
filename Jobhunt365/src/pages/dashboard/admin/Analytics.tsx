...
const Analytics = () => {
  return (
    <div className='flex flex-col mb-4 mx-4 mt-16 md:mx-8'>
      <section className='flex flex-col   '>
        <div className='mt-4 grid-cols-1  grid lg:grid-cols-4 items-center gap-4 md:grid-cols-4  justify-between'>
        ...
        <div className='w-full grid grid-cols-2 gap-4  md:order-1 order-2'>
          ...
          <div className='flex mt-4  gap-4'>
            <div className='w-1/2 bg-white flex justify-center items-center p-1'>
              <AreaChartComponent />
            </div>
