...
const FilterComponent = () => {
  return (
    <aside className='p-4 flex flex-col w-full gap-6 bg-white rounded-md max-h-screen overflow-y-scroll'>
      <div className='flex items-center justify-between  w-full'>
        <h2 className='capitalize text-sm text-[#6b7280] font-bold'>Filters</h2>
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='flex gap-3 items-center'>
          ...
          <label className='text-sm text-[#6b7280] capitalize' htmlFor='Remote'>
            Remote
          </label>
        </div>
        <div className='flex gap-3 items-center'>
          <input type='checkbox' name='Onsite' id='' />
          <label className='text-sm text-[#6b7280] capitalize' htmlFor='Onsite'>
            Onsite
          </label>
        </div>
        <div className='flex gap-3 items-center'>
          <input type='checkbox' name='Hybrid' id='' />
          <label className='text-sm text-[#6b7280] capitalize' htmlFor='Hybrid'>
            Hybrid
          </label>
        </div>
      </div>
